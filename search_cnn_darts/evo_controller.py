    ...
    def get_structure(self):
        ...
        for i in range(2):
            ...
            for i in range(0,4):
                ...
                indexess[i][idd[0]] = random.choice([1,2,3,4,5,6,7])
                indexess[i][idd[1]] = random.choice([1,2,3,4,5,6,7])        
        ...
        for indexess in kid.structure:
            for i in range(0,4):
                ...
                for k in range(i+2):
                    if indexess[i][k]>0:
                        if random.random()>(1-p_opwise):
                            indexess[i][k] = random.choice([1,2,3,4,5,6,7])
                        if_ops.append(k)
                    else:
                        if_none.append(k)            
                if i > 0 and random.random()>(1-p_edgewise):
                    ...
                    indexess[i][s2] = random.choice([1,2,3,4,5,6,7])#indexess[i][s1]
                    indexess[i][s1] = 0
...
#             print(group.loss ,group.count)
            print(group.loss , group.size ,group.count)
